            ...
            <div className="flex flex-col items-center justify-center w-full h-[100dvh] relative">
              ...
              >
                ...
                <div className="flex flex-col items-center text-center absolute bottom-4 left-0 right-0 z-10 transition-none p-4">
                  ...
                  {scrollToExpand && (
                    <p
                      className="text-white/80 font-medium text-center text-sm"
                      style={{ transform: `translateX(${textTranslateX}vw)` }}
                    >
                      {scrollToExpand}
                    </p>
              ...
              >
                <motion.h2
                  className="text-4xl md:text-5xl lg:text-6xl font-bold text-white transition-none font-headline"
                  style={{ transform: `translateX(-${textTranslateX}vw)` }}
                >
                  {firstWord}
                </motion.h2>
                <motion.h2
                  className="text-4xl md:text-5xl lg:text-6xl font-bold text-center text-white transition-none font-headline"
                  style={{ transform: `translateX(${textTranslateX}vw)` }}
                >
                  {restOfTitle}
                </motion.h2>
