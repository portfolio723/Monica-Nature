...
const asiaDestinations = [
  ...
  { name: 'Armenia', flag: '🇦🇲', tagline: 'Land of Ancient Monasteries', bestSeason: 'May - June, September - October', highlights: 'Yerevan, Lake Sevan, Tatev Monastery, Mount Ararat views', natureFocus: 'Mountainous landscapes, alpine lakes, dramatic gorges', href: '#' },
  { name: 'Azerbaijan', flag: '🇦🇿', tagline: 'Land of Fire', bestSeason: 'April - June, September - October', highlights: 'Baku, Gobustan rock art, mud volcanoes, Sheki', natureFocus: 'Unique geology, Caspian Sea coast, mountain villages', href: '#' },
  ...
  { name: 'Bhutan', flag: '🇧🇹', tagline: 'Land of the Thunder Dragon', bestSeason: 'March - May, September - November', highlights: 'Tiger`s Nest Monastery, Punakha Dzong, Gross National Happiness', natureFocus: 'Pristine Himalayan landscapes, unique culture', href: '#' },
  ...
  { name: 'Cambodia', flag: '🇰🇭', tagline: 'Kingdom of Wonder', bestSeason: 'November - April', highlights: 'Angkor Wat, Koh Rong Islands, Cardamom Mountains', natureFocus: 'Ancient temples reclaimed by jungle, rare wildlife', href: '#' },
  { name: 'China', flag: '🇨🇳', tagline: 'Land of Dragons and Diversity', bestSeason: 'April - May, September - October', highlights: 'Great Wall, Zhangjiajie National Park, Li River, Giant Pandas', natureFocus: 'Karst landscapes, giant pandas, diverse ecosystems', href: '#' },
  { name: 'Cyprus', flag: '🇨🇾', tagline: 'Mythical Island of Aphrodite', bestSeason: 'April - June, September - October', highlights: 'Paphos archaeological sites, Troodos Mountains, pristine beaches', natureFocus: 'Mediterranean coastline, pine-clad mountains, sea caves', href: '#' },
  ...
  { name: 'Georgia', flag: '🇬🇪', tagline: 'The Balcony of Europe', bestSeason: 'May - June, September', highlights: 'Tbilisi, Caucasus Mountains, Svaneti, Kakheti wine region', natureFocus: 'High mountains, lush valleys, ancient cave cities', href: '#' },
  {
    name: 'India',
    flag: '🇮🇳',
  ...
  { name: 'Israel', flag: '🇮🇱', tagline: 'Ancient History & Modern Innovation', bestSeason: 'March - May, September - November', highlights: 'Jerusalem, Tel Aviv, Masada, Galilee', natureFocus: 'Diverse landscapes from desert to sea, historical and religious sites', href: '#' },
  {
    name: 'Japan',
    flag: '🇯🇵',
  ...
  { name: 'Jordan', flag: '🇯🇴', tagline: 'Kingdom of Time', bestSeason: 'March - May, September - November', highlights: 'Petra, Wadi Rum, Dead Sea, Roman ruins of Jerash', natureFocus: 'Desert landscapes, unique geology, ancient history', href: '#' },
  { name: 'Kazakhstan', flag: '🇰🇿', tagline: 'Land of the Great Steppe', bestSeason: 'April - June, September - October', highlights: 'Almaty, Charyn Canyon, Kolsai Lakes, Big Almaty Lake', natureFocus: 'Vast steppes, dramatic canyons, alpine lakes', href: '#' },
  ...
  { name: 'Kyrgyzstan', flag: '🇰🇬', tagline: 'Switzerland of Central Asia', bestSeason: 'July - September', highlights: 'Issyk-Kul Lake, Ala Archa National Park, Song Kul Lake', natureFocus: 'Pristine mountains, nomadic culture, alpine lakes', href: '#' },
  ...
  { name: 'Malaysia', flag: '🇲🇾', tagline: 'A Fusion of Cultures & Rainforests', bestSeason: 'March - October (West Coast), April - September (East Coast)', highlights: 'Borneo Rainforest, Cameron Highlands, Langkawi', natureFocus: 'Orangutans, ancient rainforests, world-class diving', href: '#' },
  { name: 'Maldives', flag: '🇲🇻', tagline: 'The Sunny Side of Life', bestSeason: 'November - April', highlights: 'Overwater bungalows, vibrant coral reefs, pristine beaches', natureFocus: 'World-class diving and snorkeling, marine life', href: '#' },
  { name: 'Mongolia', flag: '🇲🇳', tagline: 'Land of the Eternal Blue Sky', bestSeason: 'June - August', highlights: 'Gobi Desert, Eagle Hunters, Naadam Festival, nomadic life', natureFocus: 'Vast steppes, desert landscapes, nomadic culture', href: '#' },
  ...
  { name: 'Oman', flag: '🇴🇲', tagline: 'Arabian Peninsula`s Hidden Gem', bestSeason: 'October - April', highlights: 'Muscat, Wahiba Sands, Jebel Shams, Musandam Fjords', natureFocus: 'Wadis, deserts, mountains, and pristine coastline', href: '#' },
  { name: 'Pakistan', flag: '🇵🇰', tagline: 'The Land of Majestic Peaks', bestSeason: 'May - October', highlights: 'K2 Base Camp, Hunza Valley, Fairy Meadows, Badshahi Mosque', natureFocus: 'Some of the world`s highest mountains, glaciers, alpine valleys', href: '#' },
  ...
  { name: 'Philippines', flag: '🇵🇭', tagline: 'Archipelago of Natural Wonders', bestSeason: 'November - April', highlights: 'Palawan, Chocolate Hills of Bohol, Rice Terraces of Banaue', natureFocus: 'Pristine beaches, coral reefs, unique geological formations', href: '#' },
  ...
  { name: 'Saudi Arabia', flag: '🇸🇦', tagline: 'The Cradle of Arabia', bestSeason: 'November - February', highlights: 'Al-Ula, Riyadh, Jeddah, Edge of the World', natureFocus: 'Vast deserts, ancient tombs, Red Sea coral reefs', href: '#' },
  {
    name: 'Singapore',
    flag: '🇸🇬',
  ...
  { name: 'South Korea', flag: '🇰🇷', tagline: 'Dynamic Culture & Scenic Landscapes', bestSeason: 'March - May, September - November', highlights: 'Jeju Island, Seoraksan National Park, Gyeongju', natureFocus: 'Volcanic islands, dramatic mountains, coastal scenery', href: '#' },
  {
    name: 'Sri Lanka',
    flag: '🇱🇰',
  ...
  { name: 'Tajikistan', flag: '🇹🇯', tagline: 'The Roof of the World', bestSeason: 'June - September', highlights: 'Pamir Highway, Fann Mountains, Iskanderkul Lake', natureFocus: 'High-altitude trekking, dramatic mountain passes', href: '#' },
  {
    name: 'Thailand',
    flag: '🇹🇭',
  ...
  { name: 'Turkey', flag: '🇹🇷', tagline: 'Where East Meets West', bestSeason: 'April - May, September - October', highlights: 'Istanbul, Cappadocia, Ephesus, Pamukkale', natureFocus: 'Unique landscapes, Mediterranean coastlines, historical sites', href: '#' },
  { name: 'Turkmenistan', flag: '🇹🇲', tagline: 'Gateway to Hell', bestSeason: 'April - June, September - October', highlights: 'Darvaza Gas Crater, Ashgabat, ancient Merv', natureFocus: 'Karakum Desert, unique geological phenomena', href: '#' },
  { name: 'United Arab Emirates', flag: '🇦🇪', tagline: 'Futuristic Cities & Desert Adventures', bestSeason: 'November - March', highlights: 'Dubai, Abu Dhabi, Desert Safaris, Sheikh Zayed Mosque', natureFocus: 'Desert landscapes, coastal areas, modern architecture', href: '#' },
  { name: 'Uzbekistan', flag: '🇺🇿', tagline: 'Heart of the Silk Road', bestSeason: 'April - May, September - October', highlights: 'Samarkand, Bukhara, Khiva, Tashkent', natureFocus: 'Ancient cities, desert landscapes, Silk Road history', href: '#' },
  { name: 'Vietnam', flag: '🇻🇳', tagline: 'Timeless Charm & Natural Beauty', bestSeason: 'March - April, September - November', highlights: 'Ha Long Bay, Hoi An Ancient Town, Mekong Delta', natureFocus: 'Karst landscapes, lush rice paddies, diverse ecosystems', href: '#' },
